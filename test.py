...
pool1 = Pool(name="pool1", assets=["A", "B"], amounts=[100, 200], converter=converter)
pool2 = Pool(name="pool2", assets=["A", "B"], amounts=[5000, 40], converter=converter)
pool3 = Pool(name="pool3", assets=["A", "B"], amounts=[500, 4], converter=converter)
